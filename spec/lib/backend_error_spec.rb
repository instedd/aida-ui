...
RSpec.describe BackendError, :type => :helper do
  describe "skill errors" do
    ...
    it "returns errors for decision tree when missing answer" do
      errors_in =
      [{
        "path" => "#/skills/0",
        "error" => {
      ...
      errors_out = [{:message=>'required', :path=>["skills/0", "tree/responses/0/next", "answer/en"]}]
      expect(BackendError.parse_errors(errors_in)).to eq(errors_out)
    end

    it "returns errors for decision tree when missing answer in the second level" do
      errors_in =
      [{
        "path" => "#/skills/0",
        "error" => {
      ...
      errors_out = [{:message=>"required", :path=>["skills/0", "tree/responses/0/next", "responses/0/next", "answer/en"]}]
      expect(BackendError.parse_errors(errors_in)).to eq(errors_out)
    end

    it "returns errors for decision tree when deeper and multiple errors" do
      errors_in =
      [{
        "path" => "#/skills/0",
        "error" => {
          "valid_indices" => [], "invalid" => [{
            ...
            "index" => 3,
            "errors" => [{
              "path" => "#/tree/responses/1/next",
              "error" => {
                "valid_indices" => [], "invalid" => [{
                  "index" => 0,
                  "errors" => [{
                    "path" => "#/responses/2/next",
                    "error" => {
                      "valid_indices" => [], "invalid" => [{
                        "index" => 0,
                        "errors" => [{
                              ...
                              "errors" => [{
                                ...
                                "error" => {
                                  "valid_indices" => [], "invalid" => [{
                                    "index" => 0,
                                    "errors" => [{
                                      "path" => "#/responses/1/next",
                                      "error" => {
                                        "valid_indices" => [], "invalid" => [{
                                          "index" => 0,
                                          "errors" => [{
                                            "path" => "#/responses/3/next",
                                            "error" => {
                                              "valid_indices" => [], "invalid" => [{
                                                "index" => 0,
                                                "errors" => [{
